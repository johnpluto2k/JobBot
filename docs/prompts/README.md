...
| [`frontend_redesign.md`](frontend_redesign.md) | ⏳ pending | Finish the stalled sidebar-nav migration (replace the 12-tab horizontal strip), mount the orphaned `ResumeStudioTab`, finish `FindJobsTab`'s site picker, and standardize primary/secondary action-button placement across the React app. |
